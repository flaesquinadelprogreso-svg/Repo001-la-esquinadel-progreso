...
const variantStyles = {
    primary: { backgroundColor: '#F2A900', color: '#FFFFFF', border: 'none' },
    ...
    outline: { backgroundColor: 'transparent', color: '#F2A900', border: '1px solid #F2A900' },
};

const hoverBg = {
    primary: '#FFBF00', secondary: '#F0F2F5', danger: '#B91C1C',
    success: '#15803D', ghost: '#F0F2F5', outline: '#FFF8E7',
};
